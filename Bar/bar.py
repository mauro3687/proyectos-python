...
def pedidos():
    ...
    ventana1.geometry('960x700')
    ventana1.iconbitmap("0001.ico")

logeo=Button(mi_frame,text="Logeo").place(x=100,y=100)
pedi=Button(mi_frame,text="Pedidos",command=pedidos).place(x=100,y=200)
admin=Button(mi_frame,text="Administracion").place(x=50,y=300)
